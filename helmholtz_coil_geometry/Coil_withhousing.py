...
#loc_coil_2 = cq.Location(cq.Vector(0, 0, helmholtz_radius))          #only doing a single coil for now

assembly.save('coil_with_housing.stl')

#cq.exporters.export(housing_combined, 'housing.stl', tolerance=0.01)
#cq.exporters.export(coil, 'coil.stl', tolerance=0.01)